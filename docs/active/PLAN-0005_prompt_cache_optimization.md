...
|----|------|-------|--------|-----|
| T1 | Modify `ContextEngine` — freeze system prompt, add dynamic context method | agent_core | Todo | 2026-06-26 |
| T2 | Modify `Run::refresh_context_segments()` — inject context as messages, not segments | agent_core | Todo | 2026-06-26 |
| T3 | Add conversation window cap to `trim_to_fit()` | agent_core | Todo | 2026-06-26 |
| T4 | Update `prompt.rs` with output compression instructions | agent_core | Todo | 2026-06-26 |
| T5 | Guard tool catalog against unnecessary re-registrations | agent_core | Todo | 2026-06-26 |
...
| M2 | Phase 2 merged — conversation window cap active | 2026-06-26 |
| M3 | Phases 3+4 merged — compression + tool stability | 2026-06-27 |
| M4 | Validation — measure and confirm cache hit rate > 50% | 2026-06-27 |
