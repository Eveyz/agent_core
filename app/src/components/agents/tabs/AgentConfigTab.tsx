          ...
          <div>
            ...
            <div className="input-container" style={{ position: "relative" }}>
              ...
              <textarea
                ...
                style={{ color: "var(--text-main)", minHeight: "240px", resize: "vertical", borderTopLeftRadius: selectedSkills.length ? 0 : undefined, borderTopRightRadius: selectedSkills.length ? 0 : undefined }}
              />
